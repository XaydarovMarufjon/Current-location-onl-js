...
model Country {
  ...
  nameru            String
  // countryId         String
  // macroRegional     MacroRegional @relation(fields: [countryId], references: [id])
  // region            Region[]
  creatorId         String
  editorId          String
  removerId         String?
...
model Region {
  ...
  nameru    String
  // regionId  String
  // country   Country  @relation(fields: [regionId], references: [id])
  // district  District[]
  creatorId String
  editorId  String
  removerId String?
...
model District {
  ...
  name       String   @unique
  // districtId String 
  // region        Region  @relation(fields: [districtId], references: [id])
...
model Neighborhood {
  ...
  // district       District  @relation(fields: [neighborhoodId], references: [id])
  nameuz     String
  nameru     String
  creatorId  String
  editorId   String
